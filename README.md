...
- Use media queries at a 768px breakpoint (DONE)
- As a user changes the size of a browser window:

  - Content remains in appropriate ```divs``` (DONE)
  - Content remains visible to the user (DONE)
  - Fonts change size appropriately (DONE)
  - Margins and padding change size appropriately (DONE)
  - Content does not overlap (DONE)
